    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "WebSite",
            "name": "CashFlow",
            "url": "https://tonotos.castelancarpinteyro.com/"
        }
    </script>
...
<body>
        ...
        <div class="container pt-4 pt-xl-5">
            <div class="row pt-5">
                ...
                <div class="col-12 col-lg-10 mx-auto">
                    <div class="text-center position-relative"><img class="img-fluid" src="{{ asset('assets/img/illustrations/meeting.svg?h=c663f8d8c612bee13c84963c242e37c8') }}" style="width: 800px;"></div>
                </div>
            </div>
    ...
    <section class="py-4 py-xl-5">
        <div class="container">
            <div class="text-white bg-primary border rounded border-0 border-primary d-flex flex-column justify-content-between flex-lg-row p-4 p-md-5">
                ...
                <div class="my-2"><a class="btn btn-light fs-5 px-4 py-2" role="button" href="{{ asset('contacts.html') }}">Contact us</a></div>
            </div>
        </div>
    ...
    <script src="{{ asset('https://cdnjs.cloudflare.com/ajax/libs/Chart.js/4.4.1/chart.min.js') }}" integrity="sha512-L0Shl7nXXzIlBSUUPpxrokqq4ojqgZFQczTYlGjzONGTDAcLremjwaWv5A+EDLnxhQzY5xUZPWLOLqYRkY0Cbw=="></script>
